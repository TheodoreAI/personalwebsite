...
app.post("/dashboard", (req, res) => {
    ...
    if (errors.length > 0) {
        ...
        pool.query(`INSERT INTO about (name, title, descript)
        VALUES($1, $2, $3)`, [name, title, descript], (err, results) => {
            if (err) {
                throw err;
            }
    ...
    if (errors.length > 0) {
        ...
        pool.query(
            ...
            SET
                ...
                title = $5
            WHERE 
                id = $1`, [id, name, parseInt(visits), descript, title], (err) => {
                if (err) {
                    console.log(id, name, parseInt(visits), descript, title);
                    throw err;
                }
